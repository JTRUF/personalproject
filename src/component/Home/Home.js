    ...
    return (
        <div>
            ...
            <div className="social-media-links">
                ...
                <a href="https://www.facebook.com/ashleethechristmastreelady/" target="_blank"><img className="Facebook_logo" src={facebook} alt="Facebook_logo"/></a>
                ...
                <a href="https://www.pinterest.com/ashleethechristmastreelady/" target="_blank"><img className="Pinterest_logo" src={pinterest} alt="Pinterest_logo"/></a>

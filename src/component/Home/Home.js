    ...
    return (
        <div>
            ...
            <div className="social-media-links">
                ...
                <a href="https://www.facebook.com/TheChritstmasTreeLady/"><img className="Facebook_logo" src={facebook} alt="Facebook_logo"/></a>

                <a href="https://www.instagram.com/ashleethechristmastreelady"><img className="Instagram_logo" src={instagram} alt="Instagram_logo"/></a>
